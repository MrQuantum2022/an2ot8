    ...
    if not st.session_state.selected_batch:
        ...
        if st.session_state.section_comments:
            ...
            with st.form("annotation_form"):
                ...
                categories = st.multiselect("Categories", options=['none','religion', 'race', 'caste', 'regionalism', 'terrorism','language', 'body shaming', 'disability', 'age', 'gender', 'sexual', 'political', 'privacy', 'cyber bully'])
